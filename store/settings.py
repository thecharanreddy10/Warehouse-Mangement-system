...
STATICFILES_STORAGE = (
    "whitenoise.storage.CompressedManifestStaticFilesStorage"  # deployment settings
)
...
SITE_ID = (
    1  # this is the first site. When we have multiples apps we have more site_id's
)
